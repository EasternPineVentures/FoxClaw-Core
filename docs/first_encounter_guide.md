...
FoxClaw helps people avoid turning good information into bad decisions.
...
FoxClaw is the judgment layer. It looks at public information, checks evidence,
keeps receipts, and stays paper-only.
...
Planifier is the planning layer. It already exists, and the next work is
connecting it cleanly so a person can turn information into a plan.
