...
FoxClaw is the judgment and receipt engine. CoinFox has the bones of the big
social trading surface, but it still needs a lot of work before it feels like
the familiar open feed we want: people posting ideas, discussing markets,
voting, commenting, and following calls as they play out. Planifier is already
built as a planning product, but it needs focused work before it becomes the
polished practice layer for this flow.
...
4. Move to CoinFox: explain the social feed vision, then show a public
   intelligence card fixture with claim, evidence, attention, risk, tradeability,
   invalidation, and what a professional would wait for.
...
- Do not imply CoinFox internals are complete.
