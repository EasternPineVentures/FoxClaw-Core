...
python -m pytest tests\unit\test_public_contract_schemas.py tests\unit\test_public_intelligence_card_demo.py tests\unit\test_foxclaw_gym.py -q
...
- no raw DB demo;
- no claim that scaffolded CoinFox or Planifier internals are complete.
