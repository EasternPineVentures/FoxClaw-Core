...
| FoxClaw Ledger V0 | LOCAL ONLY | `foxclaw/ledger/`, `docs/ledger/foxclaw_ledger_v0.md`, `tools/ledger_record_demo.py` |
...
- Local-only FoxClaw Ledger V0 receipts and review tasks for coordination packet history.
